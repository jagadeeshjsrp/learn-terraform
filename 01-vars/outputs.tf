...
# In above case we are just printing just variable, If variable is a combination of some strings then following is the syntax
# ${} is mandetory if we include the variable inside a string
